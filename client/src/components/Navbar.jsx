      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="text-2xl font-bold text-blue-600 pr-4">
              {import.meta.env.VITE_APP_NAME}
            </Link>
...
"
            ...
            <div className="flex items-center gap-5">
              ...
              <Link to="/wishlist" className="relative border-[var(--border)]">
                <FaHeart
                  size={22}
                  className=" bg-[var(--bg)]
  text-[var(--text)]
  ...
  border-[var(--border)] rounded-[50%] h-10 w-10 p-1.5"
              ...
              <Link to="/cart" className="relative border-[var(--border)]">
                <FaShoppingCart
                  size={22}
                  className=" bg-[var(--bg)]
  text-[var(--text)]
  ...
  border-[var(--border)] rounded-[50%] h-10 w-10 p-1"
              ...
              >
                {isLoggedIn ? (
                  <div className="font-bold h-10 w-10 p-1 text-2xl bg-[var(--bg)] rounded-[50%] border border-[var(--border)] ">
